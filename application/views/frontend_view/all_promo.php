            ...
            <div class="row">
                ...
                <div class="row"> 
                    <div class="col-xs-12 col-sm-3 col-md-3">
                        <a href="<?php echo base_url().'home/detail_promo/'.$row['id']?>">
                    ...
                    <div class="col-xs-12 col-sm-9 col-md-9">
                        <div class="list-group">
                            <div class="list-group-item">
                                <div class="row-picture">
                                    <a href="<?php echo base_url().'home/detail_promo/'.$row['id']?>" title="sintret">
                        ...
                        <a title="Read More" href="<?php echo base_url().'home/detail_promo/'.$row['id']?>">Read More</a>
                    </div> 
                </div>
            <?php endforeach ?>
            </div>
