...
INSERT INTO `mst_member` (`id`, `member_id`, `sponsor_id`, `upline_id`, `no_hp`, `name`, `plan`, `level`, `value`, `mothers_name`, `bank`, `no_rek`, `bank_an`, `city`, `password`, `status`, `position`, `downline_count`, `date`, `time`, `photo`) VALUES
